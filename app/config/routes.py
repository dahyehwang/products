...
routes['POST']['/products/add_submit'] = 'Products#add_submit'
routes['GET']['/products/show/<int:id>'] = 'Products#show'
routes['GET']['/products/edit/<int:id>'] = 'Products#edit'
routes['POST']['/products/edit_submit/<int:id>'] = 'Products#edit_submit'
routes['POST']['/products/delete/<int:id>'] = 'Products#delete_submit'
"""
